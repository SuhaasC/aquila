      ...
      <PageTransition>
          ...
          <div className="relative z-10 w-full text-center max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <FadeIn delay={0.3}>
              <div className="flex flex-col gap-4 sm:flex-row sm:gap-6 justify-center items-center px-4">
                <Button 
                  size="lg"
                  className="w-full sm:w-auto bg-brand-gold hover:bg-brand-gold/90 text-brand-navy px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-2xl shadow-2xl hover:shadow-brand-gold/25 transition-all duration-300 hover:-translate-y-1"
                ...
                <Button 
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto border-2 border-white/30 text-white hover:bg-white hover:text-brand-navy px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-2xl transition-all duration-300 hover:-translate-y-1"
                >
                  Talk to an Expert
            ...
            {/* Hero Stat */}
            <FadeIn delay={0.4}>
              <div className="mt-12 sm:mt-16 inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 max-w-sm mx-auto">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-brand-gold flex-shrink-0" />
        ...
        <Section className="bg-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-stretch">
              {/* Left Side - Problem */}
              <FadeIn delay={0.1}>
                <Card className="p-8 bg-gradient-to-br from-slate-50 to-slate-100 border-slate-200 relative overflow-hidden h-full">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-slate-200/30 rounded-full -translate-y-16 translate-x-16"></div>
                    ...
                    <div className="mt-auto">
                      <ul className="space-y-1.5">
                        {[
                          ...
                          <li key={index} className="flex items-center gap-3 text-slate-700 text-sm sm:text-base">
              ...
              <FadeIn delay={0.2}>
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-brand-navy to-slate-800 rounded-2xl p-6 sm:p-8 text-white">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-gold/20 rounded-xl flex items-center justify-center">
                        <BarChart3 className="w-5 h-5 sm:w-6 sm:h-6 text-brand-gold" />
                      </div>
        ...
        <Section className="bg-gradient-to-br from-slate-50 to-white">
          ...
          <div className="space-y-20">
            ...
            <FadeIn delay={0.1}>
              <Card className="p-8 sm:p-12 bg-white border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-stretch">
                  <div className="flex flex-col justify-center">
                    <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-brand-navy/10 rounded-full mb-6 sm:mb-8">
                    ...
                    <div className="space-y-4 sm:space-y-5">
                      {[
                        ...
                        <div key={index} className="flex items-center gap-4 sm:gap-5">
                          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-brand-gold rounded-full"></div>
                  ...
                  <div className="relative">
                    ...
                    <div className="p-6 sm:p-8 bg-brand-navy/5 rounded-3xl border border-brand-navy/10">
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-bold text-brand-navy mb-2 sm:mb-3">Impact</div>
                        <div className="text-sm sm:text-base md:text-lg text-slate-600">Faster reporting cycles, fewer errors, penalties avoided</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card className="p-8 sm:p-12 bg-white border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-stretch">
                  <div className="lg:order-2 flex flex-col justify-center">
                    <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-brand-gold/10 rounded-full mb-6 sm:mb-8">
                      <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-brand-gold" />
                      <span className="text-xs sm:text-sm font-semibold tracking-wider text-brand-gold uppercase">Speed & Efficiency</span>
                    </div>
                  ...
                  <div className="lg:order-1 relative">
                    ...
                    <div className="p-6 sm:p-8 bg-brand-gold/5 rounded-3xl border border-brand-gold/10">
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-bold text-brand-gold mb-2 sm:mb-3">Impact</div>
                        <div className="text-sm sm:text-base md:text-lg text-slate-600">Reduced trade breaks, improved execution speed, significant operational savings</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <FadeIn delay={0.3}>
              <Card className="p-8 sm:p-12 bg-white border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-stretch">
                  <div className="flex flex-col justify-center">
                    <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-green-500/10 rounded-full mb-6 sm:mb-8">
                      <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
                      <span className="text-xs sm:text-sm font-semibold tracking-wider text-green-600 uppercase">Process Optimization</span>
                    </div>
                    <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-brand-navy mb-6 sm:mb-8 tracking-tight leading-tight">
                      Claims Process Optimisation
                    </h3>
                  ...
                  <div className="relative">
                    ...
                    <div className="p-6 sm:p-8 bg-green-500/5 rounded-3xl border border-green-500/10">
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-2 sm:mb-3">Impact</div>
                        <div className="text-sm sm:text-base md:text-lg text-slate-600">Shorter claims cycles, higher customer satisfaction, reduced fraud leakage</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-stretch">
              ...
              <FadeIn delay={0.2}>
                <div className="space-y-6">
                  {/* Headline Stat */}
                  <div className="bg-gradient-to-br from-brand-gold to-amber-500 rounded-3xl p-6 sm:p-8 text-center text-brand-navy">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/20">
                    <div className="grid grid-cols-3 gap-3 sm:gap-4 items-center">
                      <div className="text-center">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                          <Database className="w-6 h-6 sm:w-8 sm:h-8 text-red-400" />
                        </div>
                      ...
                      <div className="flex justify-center">
                        <div className="w-8 sm:w-12 h-1 bg-gradient-to-r from-red-400 via-brand-gold to-green-400"></div>
                      </div>
                      
                      <div className="text-center">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                          <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 text-green-400" />
                        </div>
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:gap-4">
                    {[
                      ...
                      <div key={index} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/5 rounded-xl border border-white/10">
        ...
        <Section className="bg-gradient-to-br from-slate-900 via-brand-navy to-slate-900 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <FadeIn delay={0.2}>
              ...
              >
                Schedule a Private Consultation
                <Calendar className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 ml-2 sm:ml-3" />
              </Button>
            </FadeIn>
          </div>
        </Section>
