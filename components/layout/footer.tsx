...
const navigation = [
  { name: "Home", href: "/" },
  { name: "Ways to Work Together", href: "/services" },
    ...
    <footer className="bg-gradient-to-br from-slate-900 via-brand-navy to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          {/* Logo & Brand Section - Spans 4 columns */}
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-serif text-brand-gold font-semibold leading-tight">
          ...
          <div className="lg:col-span-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  <li>
                    <Link href="/#services-section" className="text-white/80 hover:text-brand-gold transition-all duration-300 text-base font-medium group">
                      <span className="group-hover:translate-x-1 inline-block transition-transform duration-300">
                ...
                <ul className="space-y-4">
                  ...
                  <li>
                    <Link
                      ...
                      className="text-white/80 hover:text-brand-gold transition-all duration-300 text-base font-medium group flex items-center gap-2"
                    >
